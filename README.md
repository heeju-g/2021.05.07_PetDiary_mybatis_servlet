...
<div markdown="1"> </br>  
   ...
   6. 닮은 동물 찾기 - 머신러닝(특정 동물과 닮은 연예인 사진 이용)을 통해 실제 사용자의 웹캠<br>   혹은 사진 업로드 시, 닮은 동물을 찾아주는 기능    </br></br>    
   7. 날씨 - 원하는 지역 날씨정보 제공   </br></br>    
   8. 지도 - 가게 및 병원 등의 위치 표기 및 거리, 이동시간 확인기능. <br>   데이터베이스와 연결하여 저장된 업체 위치 표기 및 검색기능   </br></br>    
   9. 비속어 필터링 - 게시글에서 비속어 필터링 기능을 통해 해당 게시물을 읽어들여<br>  욕설로 판단되는 단어를 특수문자로 변경   </br></br>    
