...
<head>
    ...
    <style type="text/css">
        ...
        *{ margin: 0; padding: 0; }
        ...
        .startUpload{padding:5px 15px; margin:5px 3px 5px 205px; border:none; background-color: wheat;border-radius: 4px;cursor:pointer;font-size: 13px;}
        .predictUpload{padding:5px 15px; margin:5px 3px 5px auto; border:none; background-color: salmon;cursor:pointer;border-radius: 4px;font-size:13px;}
  		.teachable_button{
...
<div id="imgWrap"  style="display: none">
    <div class="teachable_text">
      
    </div>
    <div class="teachable_button">
        <button  type="button" class="startUpload" onclick="initUpload();">Start</button>
        <button type="button" class="predictUpload" onclick="predictUpload();">Predict</button>
    </div>
