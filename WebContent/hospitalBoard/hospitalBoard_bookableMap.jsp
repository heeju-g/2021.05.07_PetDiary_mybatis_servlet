...
<body>
	<div class="mapHeader"><i class="fas fa-paw"></i>  등록된 병원보기  <i class="fas fa-paw"></i></div>
	<div class="map_wrap">
      ...
      function bookableMap(){
  		$.ajax({
  			...
  			success:function(data){
  				...
  				//[{"business_addr":"경기도 고양시 토당동","business_name":"도담동물병원"},{"business_addr":"경기도 고양시 토당동","business_name":"도담동물병원"},]
  				// -> var listData = [["경기도 고양시 토당동","도담동물병원"],[,],,];
  			
 				//자바스크립트는 [][] 이렇게 2차원배열 생성 불가해서 아래처럼 만들어줘야함(""이게 중요한게 아니라 배열,객체인가가 중요한 것)
  				var list = new Array();
